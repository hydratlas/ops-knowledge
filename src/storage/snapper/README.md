...
| `snapper_config_overrides` | 下記参照 | 全コンフィグに適用するキー＝値 |
...
sudo perl -pi -e 's/^TIMELINE_LIMIT_HOURLY=.+$/TIMELINE_LIMIT_HOURLY="3"/g; s/^TIMELINE_LIMIT_DAILY=.+$/TIMELINE_LIMIT_DAILY="5"/g; s/^TIMELINE_LIMIT_MONTHLY=.+$/TIMELINE_LIMIT_MONTHLY="2"/g; s/^TIMELINE_LIMIT_YEARLY=.+$/TIMELINE_LIMIT_YEARLY="0"/g; s/^NUMBER_LIMIT=.+$/NUMBER_LIMIT="10"/g; s/^NUMBER_LIMIT_IMPORTANT=.+$/NUMBER_LIMIT_IMPORTANT="5"/g;' "/etc/snapper/configs/$name"
```
