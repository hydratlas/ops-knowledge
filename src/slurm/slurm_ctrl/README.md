...
| `slurm_controller_hosts` | `{ "{{ ansible_fqdn }}": "" }` | コントローラーホストのFQDNとIPのマッピング（HA構成対応） |
    ...
    - role: infrastructure/slurm_ctrl
      vars:
        ...
        slurm_controller_hosts:
          slurm-ctrl-01.int.home.arpa: "10.120.91.1"  # プライマリ
          slurm-ctrl-02.int.home.arpa: "10.120.92.1"  # バックアップ
