...
UbuntuをBtrfsファイルシステムでインストールする手順です。スナップショット機能やサブボリューム管理など、Btrfsの先進的な機能を活用したシステム構築を実現します。
...
git clone --depth=1 https://github.com/hydratlas/ops-knowledge
cd ops-knowledge/src/platforms/debian-and-ubuntu-tips/install-ubuntu-with-btrfs/
